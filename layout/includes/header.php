 ...
 <?php global $USER,$PAGE, $user ?>
  ...
  <li class="first">
    ...
    <?php if (!empty($PAGE->theme->settings->enablecalendar  )) { ?> <a href="<?php echo $CFG->wwwroot; ?>/calendar/view.php"><li><i class="fa fa-calendar-o" aria-hidden="true"></i> Calendar</li></a> <?php } ?>
      ...
      <a class="normalrole" href="<?php echo $CFG->wwwroot; ?>/course/switchrole.php?id=<?php echo $USER->id; ?>&sesskey=<?php echo $USER->sesskey; ?>&switchrole=0&returnurl=/course/view.php?id=<?php echo $COURSE->id; ?>"><li><i class="fa fa-mail-reply" aria-hidden="true"></i> Return to normal role</li></a>
